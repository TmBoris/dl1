...
class LanguageModel(nn.Module):
    def __init__(self, dataset: TextDataset, embed_size: int = 256, hidden_size: int = 256,
        ...
        self.rnn = rnn_type(input_size=embed_size, hidden_size=hidden_size, batch_first=True, num_layers=rnn_layers)
    ...
    def forward(self, indices: torch.Tensor, lengths: torch.Tensor) -> torch.Tensor:
        ...
        '''
        # tokens: (B, L)
        # print(self.dataset.vocab_size)
        # print(self.dataset.bos_id, self.dataset.eos_id, self.dataset.pad_id)
